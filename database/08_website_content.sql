-- =============================================================================
-- Dealer Network Management System — Migration 08: Public website content
...
--
--   * website_insight_cards    — the "Insights & Opportunity" cards
--                                 (photo + title + date label + excerpt).
--   * website_network_cards    — the horizontal "Our Network" filmstrip cards
--                                 (photo + title + caption + accent colour).
--   * website_contact_messages — messages submitted through the site's contact
...
-- Ensure gen_random_uuid() is available (pgcrypto). No-op if already installed.
...
-- sort_order — re-running will not create duplicates).
-- ---------------------------------------------------------------------------
...
SELECT * FROM (
    ...
    ('Fast Delivery',           'From central stock in 1–2 days, anywhere in BD',     'https://picsum.photos/seed/mis-delivery/1000/1250',   '#a8ecd8', 5),
    ...
    ('Nationwide Reach',        '495+ upazilas · 64 districts · 8 divisions',         'https://picsum.photos/seed/mis-map/1000/1250',        '#F9D616', 7)
